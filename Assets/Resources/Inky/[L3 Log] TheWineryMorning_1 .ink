...
~ set_speaker(Speaker.Lupe)
[Lupe] Yeah, it's definitely been broken. But something about this seems off to me...
...
[Misra] Thoughts?
~ set_speaker(Speaker.Lupe)
[Lupe] It's obscure. Someone was definitely here, but I can't speak to motive. Who would want to break into an abandoned Winery?
~ set_speaker(Speaker.Misra)
[Misra] That sounds like it's time for some profiling! We need a suspect list.
~ set_speaker(Speaker.Lupe)
[Lupe] Any leads on who it could be?
~ set_speaker(Speaker.Misra)
...
// ADD TO SYNTHESIS
~ set_speaker(Speaker.Lupe)
[Lupe] Some of this stuff looks like it's been ripped apart. -> DONE
...
~ set_speaker(Speaker.Lupe)
[Lupe] ...It would just be a motive, if anyone was looking to take some.
~ set_speaker(Speaker.Misra)
[Misra] Oh, no. They drained all of it when the Winery closed.
~ set_speaker(Speaker.Lupe)
[Lupe] I don't drink when I'm on a case.
~ set_speaker(Speaker.Misra)
