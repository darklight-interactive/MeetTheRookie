...
namespace Darklight.UnityExt.Game.Grid
{
    partial class Cell2D
    {
        public static class ComponentFactory
        {
            ...
            {
                RegisterComponent(ComponentTypeKey.BASE, (Cell2D cell) => new Cell2D_BaseComponent(cell));
                RegisterComponent(ComponentTypeKey.OVERLAP, (Cell2D cell) => new Cell2D_OverlapComponent(cell));
                RegisterComponent(ComponentTypeKey.WEIGHT, (Cell2D cell) => new Cell2D_WeightComponent(cell));
                RegisterComponent(ComponentTypeKey.SPAWNER, (Cell2D cell) => new Cell2D_SpawnerComponent(cell));
            }
