...
namespace Darklight.UnityExt.BuildScene
{
    ...
    {
        public const string DATA_PATH = "Assets/Resources/Darklight/BuildSceneData";
        ...
        public virtual void SaveBuildSceneData(string[] buildScenePaths)
        {
            ...
            for (int i = 0; i < buildScenePaths.Length; i++)
            {
                ...
                _buildSceneData[i] = new TSceneData();
