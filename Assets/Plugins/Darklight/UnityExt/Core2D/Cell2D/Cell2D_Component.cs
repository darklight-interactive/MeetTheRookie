...
namespace Darklight.UnityExt.Core2D
{
    public partial class Cell2D
    {
                ...
                IVisitable<Component>
        {
            ...
            protected int _guid = System.Guid.NewGuid().GetHashCode();

            [SerializeField, ShowOnly]
            protected ComponentTypeKey _typeKey;
            ...
            // ---- (( GETTER METHODS )) ---- >>
            public virtual ComponentTypeKey GetTypeKey() =>
                InternalComponentRegistry.GetTypeKey(this);
        }

        public class BaseComponent : Component
        {
            public BaseComponent(Cell2D cell)
                : base(cell) { }
            ...
            public override void DrawSelectedGizmos()
            {
                ...
                Vector3 labelPos = Spatial2D.GetAnchorPointPosition(
                    position,
                    dimensions,
