...
public partial class MTRInteractable : Interactable<MTRInteractable.InternalData, MTRInteractable.InternalStateMachine, MTRInteractable.State, MTRInteractable.Type>
{
    ...
    public override Type TypeKey => Type.INTERACTABLE;
    ...
    public override void Register()
    {
        ...
        InteractionSystem.Factory.CreateOrLoadInteractionRequest(TypeKey.ToString(), out InteractionRequestDataObject newRequest);
        Request = newRequest;
