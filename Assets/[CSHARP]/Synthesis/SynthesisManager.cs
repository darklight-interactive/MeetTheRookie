...
public class SynthesisManager : UXML_UIDocumentObject
{
    ...
    void Initialize() {
        ...
        InkyStoryManager.Instance.GlobalStory.BindExternalFunction("playerAddItem", AddItem);
        InkyStoryManager.Instance.GlobalStory.BindExternalFunction("playerRemoveItem", RemoveItem);
        InkyStoryManager.Instance.GlobalStory.BindExternalFunction("playerHasItem", HasItem);
    }
    ...
    void Synthesize() {
        ...
        InkyStoryManager.Instance.GlobalStory.RunExternalFunction("synthesize", args.ToArray());
    }
    ...
    public object CombineItems(object[] args) {
        ...
        object newItem = InkyStoryManager.Instance.GlobalStory.RunExternalFunction("combine", final);
